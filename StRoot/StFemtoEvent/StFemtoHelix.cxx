//
// StFemtoHelix is a helix parametrization that uses ROOT TVector3
//
...
ClassImpT(StFemtoHelix,double);

const Double_t StFemtoHelix::NoSolution = 3.e+33;

//_________________
StFemtoHelix::StFemtoHelix() : mSingularity(false), mOrigin(0, 0, 0),
...
//_________________
StFemtoHelix::StFemtoHelix(Double_t c, Double_t d, Double_t phase,
			 const TVector3& o, Int_t h) {
  setParameters(c, d, phase, o, h);
}

//_________________
StFemtoHelix::StFemtoHelix(const StFemtoHelix &h) {
...
//_________________
StFemtoHelix::~StFemtoHelix() { /* noop */ };

//_________________
void StFemtoHelix::setParameters(Double_t c, Double_t dip, Double_t phase,
				const TVector3& o, Int_t h) {
...
//_________________
void StFemtoHelix::setCurvature(Double_t val) {
...
//_________________
void StFemtoHelix::setPhase(Double_t val) {
...
//_________________
void StFemtoHelix::setDipAngle(Double_t val) {
...
//_________________
Double_t StFemtoHelix::xcenter() const {
...
//_________________
Double_t StFemtoHelix::ycenter() const {
  if (mSingularity) {
    return 0;
  }
  else {
...
//_________________
Double_t StFemtoHelix::fudgePathLength(const TVector3& p) const {
...
//_________________
Double_t StFemtoHelix::distance(const TVector3& p, Bool_t scanPeriods) const {
  return ( this->at( pathLength(p,scanPeriods) )-p ).Mag();
}

//_________________
Double_t StFemtoHelix::pathLength(const TVector3& p, Bool_t scanPeriods) const {
...
//_________________
Double_t StFemtoHelix::period() const {
  if (mSingularity) {
#ifndef ST_NO_NUMERIC_LIMITS
...
//_________________
pair<Double_t, Double_t> StFemtoHelix::pathLength(Double_t r) const {
...
//_________________
pair<Double_t, Double_t> StFemtoHelix::pathLength(Double_t r, Double_t x, Double_t y) {
...
//________________
Double_t StFemtoHelix::pathLength(const TVector3& r,
...
//_________________
pair<Double_t, Double_t> StFemtoHelix::pathLengths(const StFemtoHelix& h, Double_t minStepSize,
...
//_________________
void StFemtoHelix::moveOrigin(Double_t s) {
...
//_________________
Int_t operator== (const StFemtoHelix& a, const StFemtoHelix& b) {
...
//_________________
std::ostream& operator<<(std::ostream& os, const StFemtoHelix& h) {
  return os << '('

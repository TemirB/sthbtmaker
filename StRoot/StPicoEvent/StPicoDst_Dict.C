...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::StPicoMcTrack*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::StPicoMcTrack*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::StPicoMcVertex*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::StPicoMcVertex*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
"/home/ubuntu/lbavinh/ROOT/root_v6.26.04/include",
"/home/ubuntu/lbavinh/ROOT/root_v6.26.04/include/",
"/home/ubuntu/lbavinh/LHEP/RACF/femtoscopy/StRoot/StPicoEvent/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$StPicoHelix.h")))  __attribute__((annotate("$clingAutoload$StPicoMcTrack.h")))  StPicoHelix;
class __attribute__((annotate("$clingAutoload$StPicoPhysicalHelix.h")))  __attribute__((annotate("$clingAutoload$StPicoMcTrack.h")))  StPicoPhysicalHelix;

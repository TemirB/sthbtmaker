#ifndef StFemtoEpdHit_h
#define StFemtoEpdHit_h
 ...
 *  the StFemtoEpdHit::id(), and you'll get all you want.
...
//_________________
class StFemtoEpdHit : public TObject {
 ...
 public:
  ...
  StFemtoEpdHit(Int_t position, Int_t tile, Int_t EW, Int_t ADC, Int_t TAC, Int_t TDC,
  ...
  /// \nMIP               calibrated ADC
  StFemtoEpdHit(Short_t id, Int_t QTdata, Float_t nMIP);
  /// Copy constructor
  StFemtoEpdHit(const StFemtoEpdHit &hit);
  /// Destructor
  virtual ~StFemtoEpdHit();
